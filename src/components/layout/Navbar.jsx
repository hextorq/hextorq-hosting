...
export default function Navbar() {
  ...
  return (
    <header data-slot="navbar" className="absolute inset-x-0 top-3 sm:top-4 z-50 flex justify-center px-3 sm:px-4 pointer-events-auto">
      <nav className="w-full rounded-2xl bg-white/80 backdrop-blur-xl shadow-[0_8px_32px_rgba(0,0,0,0.14)] transition-all duration-300 max-w-4xl border border-white/50 hover:bg-white/90">
          ...
          >
            ...
            <div className="flex flex-col">
              <div className="flex items-center space-x-1">
                ...
                <span className="text-[9px] font-mono font-bold px-1.5 py-0.2 rounded-full bg-slate-100/90 text-slate-700 uppercase tracking-wider border border-slate-200/50">
                  HOSTING
                </span>
              </div>
            </div>
          ...
          <div className="hidden lg:flex items-center space-x-1 font-sans text-xs text-[rgb(26,11,84)] font-medium">
            <div className="relative">
              <button
                ...
                className="px-2.5 py-1.5 rounded-xl hover:bg-slate-100/80 transition-colors flex items-center space-x-1"
              >
                <span>Products</span>
              ...
              {dropdownOpen && (
                <div 
                  ...
                  className="absolute top-full left-0 mt-1 w-64 p-2 rounded-2xl bg-white/95 backdrop-blur-2xl border border-slate-200 shadow-2xl space-y-1 animate-fadeIn z-50 text-slate-800"
                >
                  <button
            ...
            <button
              onClick={() => handleNavClick('shared-hosting')}
              className="px-2.5 py-1.5 rounded-xl hover:bg-slate-100/80 transition-colors"
            >
              Shared
            </button>
