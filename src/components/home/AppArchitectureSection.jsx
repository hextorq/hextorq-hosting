      ...
      <div className="w-full max-w-7xl mx-auto relative z-10">
        ...
        <div ref={specCardRef} className="mb-20 max-w-5xl mx-auto">
          <div className="rounded-[36px] bg-[rgba(10,5,20,0.88)] border border-white/15 shadow-2xl p-6 sm:p-8 relative overflow-hidden backdrop-blur-xl hover:border-white/30 transition-all duration-500">
            ...
            {/* Bottom Result Box without any dot */}
        ...
        <div ref={bannerRef} className="mt-12 p-8 sm:p-9 rounded-[36px] bg-[rgba(10,5,20,0.88)] border border-white/15 flex flex-col md:flex-row items-center justify-between gap-6 shadow-2xl backdrop-blur-xl">
          ...
          >
            <span className="w-full rounded-[11px] bg-[rgb(28,78,255)] px-7 py-3.5 text-center text-xs font-semibold text-white transition-colors duration-300 group-hover:bg-transparent flex items-center space-x-2">
