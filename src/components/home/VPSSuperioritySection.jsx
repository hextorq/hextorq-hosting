    ...
    <section ref={sectionRef} id="vps-hosting" data-slot="freedom" className="py-24 bg-white text-[rgb(26,11,84)] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center">
        ...
        <div ref={headerRef} className="text-center max-w-3xl mx-auto space-y-4 mb-14">
          ...
          {/* Clean Capability Badges without icons */}
          <div className="flex flex-wrap items-center justify-center gap-2 pt-2 text-xs font-mono text-slate-600">
            <span className="px-3.5 py-1 rounded-full bg-slate-100 border border-slate-200 text-[10px] uppercase tracking-wider font-semibold">
            ...
            <span className="px-3.5 py-1 rounded-full bg-slate-100 border border-slate-200 text-[10px] uppercase tracking-wider font-semibold text-blue-700">
              14-Day Free Trial
            </span>
          </div>
        </div>

        {/* Pricing Modern Segmented Button */}
        <div className="flex justify-center mb-10">
          <div className="inline-flex p-1 rounded-2xl bg-slate-100 border border-slate-200 shadow-sm text-xs font-mono">
            <button
              type="button"
